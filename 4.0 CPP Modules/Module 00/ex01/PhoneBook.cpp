...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/12 15:13:12 by mdarbois          #+#    #+#             */
/*   Updated: 2023/10/12 15:13:13 by mdarbois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PhoneBook::search(void)
{
  ...
  while (str == "")
  {
    ...
    int x;
    container >> x;
    if (!str.empty() && !only_digits(str) && x <= (_nbContact - 1))
    {
      std::cout << "First name: " << _contacts[x].get_first_name() << std::endl;
      std::cout << "Last name: " << _contacts[x].get_last_name() << std::endl;
      std::cout << "Nickname: " << _contacts[x].get_nickname() << std::endl;
      std::cout << "Phone number: " << _contacts[x].get_phone_number() << std::endl;
      std::cout << "Darkest secret: " << _contacts[x].get_darkest_secret() << std::endl;
    }
    else
    {
